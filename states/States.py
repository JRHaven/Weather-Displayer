...
class NoBackups(State):
    ...
    # Handle inability to get hourly weather JSON data
    def handleError(self, myName):
        self.__logger.log("STATE ", "No backups, when backups were required. Telling the user and quitting...")
        system("clear")
...
class JSONWrongURL(State):
    ...
    # Handle inability to get hourly weather JSON data
    def handleError(self, myName):
        self.__logger.log("STATE ", "JSON decode error - probably wrong url. Telling the user and quitting...")
        system("clear")
...
class ServerError(State):
    ...
    # Handle inability to get hourly weather JSON data
    def handleError(self, myName):
        self.__logger.log("STATE ", "HTTP 503 error. Telling the user and quitting...")
        system("clear")
...
class NoGenJSON(State):
    ...
    def handleError(self, myName):
        self.__logger.log("STATE ", "Couldn't get general weather JSON. Prompting user to quit...")
        system("clear")
